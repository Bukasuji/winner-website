...
export default function Core_values() {
  return (
      <div className="bg-white pb-10">
        ...
        <div className="flex flex-col lg:flex-row mt-4 bg-[#E8E8E8] rounded-2xl max-w-screen py-8 mx-10">
            ...
            <div className="bg-white mx-2 mt-4 xl:mr-8  rounded-2xl  px-2 py-4">
                ...
                <p className="mt-2 text-xl font-medium">Creativity is one of our core values. We are creative in all we do.</p>
            </div>
