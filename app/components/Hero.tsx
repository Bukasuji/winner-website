...
export default function Hero() {
  return (
    <div className="relative max-w-screen min-w-screen bg-cover bg-[url('/assets/rectangle1.jpeg')]">
      <div className="absolute inset-0 bg-black opacity-50"></div>
      <div className="flex flex-col text-white justify-center items-center h-screen relative">
